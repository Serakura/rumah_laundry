...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 20 Jul 2023 pada 13.03
...
(11, 'Siska Aprilia', 'siskaaprl81@gmail.com', 'karyawan1', '$2y$10$rBG6s0gdPJDrNU9NXNxsAOGNIKDZAS..15cUo/i5xieIbcw2gxa1e', 'Karyawan'),
(13, 'Novi Dewi Triana', 'novidewi2001@gmail.com', 'karyawan2', '$2y$10$bSNy7GfCrfIVuBIdgJiv8eFxn.6OO1YueNV/pfpx3ZpOCeg1bXUGi', 'Karyawan'),
(14, 'Ramadhan Novianto', 'ramadhan898@gmail.com', 'karyawan3', '$2y$10$pjDpUCqJbzVt11ljuXAZIueNCvncC0bWwC6.1S1tIMt31VefykW..', 'Karyawan'),
(15, 'Muhammad Rizal Mujtahid', 'rizal76saja@gmail.com', 'karyawan4', '$2y$10$qkmkvtLljMI3pbKFND.BcO7X2sORsJ1GmczabmwdbnGXbgLS1Seh2', 'Karyawan');
...
(12, 'Gorden', '1 Hari ', 1, 5000, '-'),
(13, 'Gorden', '1 Hari', 1, 5000, '-');
...
CREATE TABLE `tb_order_ck` (
  ...
  `tgl_masuk_ck` datetime NOT NULL,
  `tgl_keluar_ck` datetime NOT NULL,
...
(16, 'CK-63FF618', 'Adam', '081000111000', 'Ds. Suka Maju', 'Cuci Komplit Reguler', '2 Hari', 2, 8000, '2023-02-28 00:00:00', '2023-03-01 00:00:00', 16000, '-'),
(17, 'CK-63FF621', 'Sischa', '082222000111', 'Ds. Suka Maju', 'Cuci Komplit Express', '5 Jam', 5, 20000, '2023-03-01 00:00:00', '2023-03-01 00:00:00', 100000, '-'),
(18, 'CK-63FF62C', 'Ayumi', '085555000555', 'Ds. Trihanggo', 'Cuci Komplit Reguler', '2 Hari', 3, 8000, '2023-02-27 00:00:00', '2023-03-01 00:00:00', 24000, '-'),
(19, 'CK-63FF710', 'Jhone', '081000000001', 'Ds. Maju Bersama', 'Cuci Komplit Express', '5 Jam', 5, 20000, '2023-03-01 00:00:00', '2023-03-01 00:00:00', 100000, '-'),
(20, 'CK-64B9020', 'test', '767867', 'test', 'Cuci Komplit Reguler', '2 Hari', 10, 8000, '2023-07-20 16:43:00', '0000-00-00 00:00:00', 80000, 'test aja'),
(21, 'CK-64B9062', 'testing1', '89127712', 'testing1', 'Cuci Komplit Reguler', '2 Hari', 10, 8000, '2023-07-20 17:01:00', '2023-07-21 17:02:00', 80000, 'test aja atuh');
...
CREATE TABLE `tb_order_cs` (
  ...
  `tgl_masuk_cs` datetime NOT NULL,
  `tgl_keluar_cs` datetime NOT NULL,
...
(8, 'CS-64B5808', 'novi', '088215422983', 'semarang barat', 'Jaket Kulit', '1 Hari', 1, 15000, '2023-07-19 00:00:00', '2023-07-20 00:00:00', 15000, '');
...
CREATE TABLE `tb_order_dc` (
  ...
  `tgl_masuk_dc` datetime NOT NULL,
  `tgl_keluar_dc` datetime NOT NULL,
  `tot_bayar` double NOT NULL,
...
(7, 'DC-63FF694', 'Johan', '081111111222', 'Ds. Baturejo', 'Cuci Kering Kilat', '1 Hari', 2, 9000, '2023-02-28 00:00:00', '2023-03-01 00:00:00', 18000, '-'),
(8, 'DC-64B57FE', 'bintang', '0882', 'semarang', 'Cuci Kering Reguler', '2 Hari', 10, 6000, '2023-07-19 00:00:00', '2023-07-20 00:00:00', 60000, '');
...
(19, 'CK-64B9020', 'test', '767867', 'test', 'Cuci Komplit Reguler', '2 Hari', 10, 8000, '20 16:43:00 Juli 2023', '00 00:00:00 00 0000', 80000, 100000, 20000, 'Sukses', 'test aja'),
(20, 'CK-64B9020', 'test', '767867', 'test', 'Cuci Komplit Reguler', '2 Hari', 10, 8000, '20 Juli 2023 16:43', '11 Januari  00:00', 80000, 150000, 70000, 'Sukses', 'test aja'),
(21, 'CK-64B9062', 'testing1', '89127712', 'testing1', 'Cuci Komplit Reguler', '2 Hari', 10, 8000, '20 Juli 2023 17:01', '21 Juli 2023 17:02', 80000, 155000, 75000, 'Sukses', 'test aja atuh');
...
(4, 'CS-64B5808', 'novi', '088215422983', 'semarang barat', 'Jaket Kulit', '1 Hari', 1, 15000, '19 Juli 2023', '20 Juli 2023', 15000, 15000, 0, 'Sukses', '');
...
--
ALTER TABLE `tb_order_cs`
  MODIFY `id_order_cs` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
