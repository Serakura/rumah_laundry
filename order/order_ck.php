                     ...
                     <div class="row-input">
                        ...
                        <div class="col-form m-1">
                           ...
                           <div class="form-grup">
                              ...
                              <input type="datetime-local" name="tgl_masuk_ck" autocomplete="off" id="tgl_order_msk">
                           </div>

                           <div class="form-grup">
                              <label for="tgl_order_klr">Tanggal Order Keluar</label>
                              <input type="datetime-local" name="tgl_keluar_ck" autocomplete="off" id="tgl_order_klr">
                           </div>
